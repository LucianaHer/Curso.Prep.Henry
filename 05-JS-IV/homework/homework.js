...
// es lo mismo que:  
//return usuario.password === password; o return usuario['password'] === password
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  producto.calcularPrecioDescuento = function () {
    ...
    prodConDcto = this.precio - (this.precio * this.porcentajeDeDescuento);
    return prodConDcto;
    }
